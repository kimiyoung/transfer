...
CAT = ['PP', 'SBAR', 'UCP', 'ADJP', 'INTJ', 'VP', 'PRT', 'LST', 'NP', 'CONJP', 'ADVP']
POSITION = ['I', 'B', 'E', 'S']
...
if __name__ == '__main__':
    word_index, word_cnt = create_word_index([TRAIN_DATA, DEV_DATA])
    wx, y, m = read_data(TRAIN_DATA, word_index)
    twx, ty, tm = read_data(DEV_DATA, word_index)
    char_index, char_cnt= create_char_index([TRAIN_DATA, DEV_DATA])
